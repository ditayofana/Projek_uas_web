...
<head>
    ...
    <link rel="icon" href="https://cdn.jsdelivr.net/npm/bootstrap-icons/icons/person-lines-fill.svg" type="image/svg+xml">
                ...
                <div class="card mb-4">
                    <div class="card-body text-center">
                        ...
                        <ul class="list-unstyled">
                            <li>Email: ditayofana@gmail.com</li>
                            <li>Telepon: +62 877-1823-9087</li>
                            <li>Alamat: Jl. Perumahan Dinoyo, Dinoyo, Kota Malang</li>
                        </ul>
                    </div>
                </div>
            </div>
