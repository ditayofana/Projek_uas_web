...
<head>
    ...
    <!-- Core theme CSS (includes Bootstrap) ganti tampilan bentuk bootstrap icon -->
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-secondary"> 
        <!-- warna bg navbar atas -->
        <div class="container">
            <a class="navbar-brand" href="bloghome.php" style= "color: White">ArtikelNews</a>
    ...
    <header class="py-1 bg-light border-bottom mb-1">
        <div class="container">
            <div class="text-center my-5">
                <h1 class="fw-bolder">Selamat Datang di ArtikelNews</h1>
                <p class="lead mb-0">Website untuk Mengakses dan Upload Artikel </p>
            </div>
        </div>
    </header>
    <!-- Page content-->
                    ...
                    <div class="card-body">
                        <form method="GET" action="bloghome.php">
                            <div class="input-group">
                                ...
                                <button class="btn btn-secondary" id="button-search" type="submit">Cari!</button>
                            </div>
                        </form>
                    </div>
                </div>
