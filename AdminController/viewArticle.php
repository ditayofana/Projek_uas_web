        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <br>
                    <button type="button" class="btn btn-warning mb-4" data-bs-toggle="modal" data-bs-target="#tambah">Add Article</button>
                    <br>
                    <br>
                    <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#articleedit<?= $no ?>">Edit</a>
                                                ...
                                                <form action="act_article.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-warning" type="submit" name="articleedit">Save</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                ...
                                                <form action="act_article.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Close</button>
                                                            <button class="btn btn-warning" type="submit" name="articledelete">Delete</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="act_article.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Close</button>
                                        <button class="btn btn-warning" type="submit" name="articlesave">Add
                                            Article</button>
                                    </div>
                            </form>
                        </div>
