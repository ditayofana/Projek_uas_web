        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <br>
                    <button type="button" class="btn btn-warning mb-4" data-bs-toggle="modal" data-bs-target="#tambah">Add Category</button>
                    <br><br>
                    <div class="card mb-4">
                            ...
                            <table id="datatablesSimple">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="#" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#catedit<?= $no ?>">Edit</a>
                                                ...
                                                <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button class="btn btn-warning" type="submit" name="catedit">Save</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                                ...
                                                <form action="act_category.php" method="POST">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Close</button>
                                                            <button class="btn btn-warning" type="submit" name="catdelete">Delete Category</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                        ...
                        <div class="modal-content">
                            ...
                            <form action="act_category.php" method="POST" enctype="multipart/form-data">
                                <div class="modal-body">
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-warning" data-bs-dismiss="modal">Close</button>
                                        <button class="btn btn-warning" type="submit" name="catsave">Add
                                            Category</button>
                                    </div>
                                </div>
                            </form>
